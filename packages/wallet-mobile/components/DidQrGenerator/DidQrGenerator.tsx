...
/**
 * DidQrGenerator component.
 *
 * Displays a modal with a QR code for the user's DID and allows sharing it.
 *
 * Features:
 * - Show QR code for the DID
 * - Display optional user name
 * - Share DID via native sharing options
 */

export const DidQrGenerator: React.FC<ShareDIDModalProps> = ({
  visible,
  onClose,
  did,
  userName,
  ...
  /**
   * Share the DID using native sharing options
   */
